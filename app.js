...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("dark-toggle-sidebar")
    ?.addEventListener("click", toggleTheme);
  document
    .getElementById("dark-toggle-mobile")
    ?.addEventListener("click", toggleTheme);
  document
    .getElementById("dark-toggle-bottom")
    ?.addEventListener("click", toggleTheme);
  ...
  let expenses = JSON.parse(
    localStorage.getItem("expense-tracker-data") || "[]",
  );
  ...
  /* ============================================================
     4.5 — UPDATE BUTTON TEXT BASED ON TYPE
     ============================================================ */
  ...
  function updateTotals() {
    ...
    if (balanceEl) {
      balanceEl.style.color =
        balance >= 0 ? "var(--income-color)" : "var(--expense-color)";
    }
  }
  ...
  form.addEventListener("submit", function (event) {
    ...
    if (currentEditId !== null) {
      ...
      const index = expenses.findIndex(
        (e) => String(e.id) === String(currentEditId),
      );
      if (index !== -1) {
        expenses[index] = {
          ...expenses[index],
